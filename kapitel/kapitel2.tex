...
\begin{figure}[]
	\begin{center}
		\begin{tikzpicture}[scale=0.64,transform shape]
			...
			\path (p18.south)+(0.0,-1.7) \ioitem{19}{\hyperref[step18txt]{\color{green}.\color{black}1}8.\phantomsection\label{step18} VCF \\ \includegraphics[width=0.9cm]{bilder/list_icon_2.png}\hspace{0.1cm}\includegraphics[width=0.9cm]{bilder/list_icon_2.png}\hspace{0.1cm}\includegraphics[width=0.9cm]{bilder/list_icon_2.png}};
